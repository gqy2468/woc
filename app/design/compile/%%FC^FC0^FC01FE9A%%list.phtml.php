<?php /* Smarty version 2.6.22, created on 2011-10-19 17:29:19
         compiled from type/list.phtml */ ?>
...
<?php if ($this->_tpl_vars['i']%2 == 0): ?>
	<tr bgcolor="#F6F6F6">
		<td><?php echo $this->_tpl_vars['item']->tid; ?>
</td>
		<td><?php echo $this->_tpl_vars['item']->name; ?>
</td>
		<td><a href="<?php echo $this->_tpl_vars['r']; ?>
type/edit/id/<?php echo $this->_tpl_vars['item']->tid; ?>
">修改</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo $this->_tpl_vars['r']; ?>
type/delete/id/<?php echo $this->_tpl_vars['item']->tid; ?>
">删除</a></td>
	</tr>
<?php else: ?>
	<tr>
